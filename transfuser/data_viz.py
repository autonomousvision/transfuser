...
class CARLA_Data(Dataset):
    ...
    def __init__(self, root, config):
        ...
        for sub_root in root:
            preload_file = os.path.join(sub_root, 'vis_pl_'+str(self.seq_len)+'_'+str(self.pred_len)+'.npy')
    ...
    def __getitem__(self, index):
        ...
        for i in range(self.seq_len + self.pred_len):
            ...
            if i < self.seq_len:
                ...
                data['lidar_bevs'].append(lidar_projection(full_lidar[i], crop=self.input_resolution))
