...
parser.add_argument('--id', type=str, default='cilrs_2', help='Unique experiment identifier.')
...
class Engine(object):
	...
	def train(self):
		...
		for data in tqdm(dataloader_train):
			...
			pred_wp = model(fronts+lefts+rights+rears, lidars, target_point, gt_velocity, bev_points, cam_points)
...
# Model
model = GeometricFusion(config, args.device)
