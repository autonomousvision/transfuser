...
from late_fusion.config import GlobalConfig
from late_fusion.data import scale_and_crop_image, transform_2d_points, lidar_to_histogram_features
...
def get_entry_point():
	return 'LateFusionAgent'


class LateFusionAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = LateFusion(self.config, 'cuda')
